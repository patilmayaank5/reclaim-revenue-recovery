...
- **Î²â‚€**: Intercept (value when all X = 0)
- **Î²â‚, Î²â‚‚...**: Coefficients (effect of each predictor)
- **Îµ**: Error term

#### Interpreting Coefficients

- **Coefficient value**: For each 1-unit increase in X, Y changes by Î² units
...
|--------|---------|------------|
| RÂ² | Variance explained | Depends on domain, 0.7+ is often good |
| Adjusted RÂ² | RÂ² penalized for extra predictors | Close to RÂ² |
...
2. Choose model based on business goals:
   - Optimizing awareness? â†’ First-touch
   - Optimizing conversion? â†’ Last-touch
   - Balanced view? â†’ Position-based or linear
