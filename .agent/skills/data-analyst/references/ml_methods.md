...
â”œâ”€ YES â†’ Use statistical methods (regression, hypothesis tests)
â””â”€ NO â†’ Is your goal to predict WHAT will happen?
    â”œâ”€ YES â†’ Use ML (if enough data) or statistical models
    â””â”€ NO â†’ Is your goal to find natural GROUPS in data?
        â”œâ”€ YES â†’ Use clustering (unsupervised ML)
        â””â”€ NO â†’ Use exploratory data analysis first
```
...
| min_samples | Minimum points to form a dense region | Start with 2 Ã— dimensions |
