...
### âŒ makeStyles (MUI v4 pattern)

```typescript
// âŒ AVOID - Old Material-UI v4 pattern
...
### âŒ styled() Components

```typescript
// âŒ AVOID - styled-components pattern
