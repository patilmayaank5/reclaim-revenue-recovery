...
// âŒ AVOID - Relative paths from deep nesting
import { apiClient } from '../../../lib/apiClient';
import { SuspenseLoader } from '../../../components/SuspenseLoader';
```
...
**Avoid:**
- camelCase: `myComponent.tsx` âŒ
- kebab-case: `my-component.tsx` âŒ
- All caps: `MYCOMPONENT.tsx` âŒ
...
// âŒ Avoid deep imports (but OK if needed)
