...
// âŒ AVOID - Implicit return type (less clear)
...
// âŒ AVOID - Mixed value and type imports
...
```typescript
// âŒ AVOID - Circumventing type safety
const data = getData() as any;  // WRONG - defeats TypeScript

// âŒ AVOID - Unsafe assertion
...
- âŒ Avoid type assertions unless necessary
