...
## ðŸ“‹ Quick Start: Component Checklist
...
## ðŸ“‹ Quick Start: Feature Checklist
...
<Grid xs={12} md={6}>             // âŒ Old syntax
```
...
- **[ðŸ“– Full Guide: references/component-patterns.md](references/component-patterns.md)**

### Data Fetching
- `useSuspenseQuery` as primary pattern
- Cache-first strategy
- API service layer in `features/{feature}/api/`
- **[ðŸ“– Full Guide: references/data-fetching.md](references/data-fetching.md)**

### File Organization
- `features/`: Domain-specific code
- `components/`: Truly reusable
- **[ðŸ“– Full Guide: references/file-organization.md](references/file-organization.md)**

### Styling with MUI v7
- `sx` prop with `SxProps<Theme>`
- Inline if <100 lines, separate if >100 lines
- **[ðŸ“– Full Guide: references/styling-guide.md](references/styling-guide.md)**

### TanStack Router
- Folder-based routing
- `createFileRoute` with lazy loading
- **[ðŸ“– Full Guide: references/routing-guide.md](references/routing-guide.md)**

### Loading & Error States
- SuspenseLoader for all loading states
- `useMuiSnackbar` for notifications
- **[ðŸ“– Full Guide: references/loading-and-error-states.md](references/loading-and-error-states.md)**

### Performance
- `useMemo` for expensive computations
- `useCallback` for handlers passed to children
- `React.memo` for expensive components
- **[ðŸ“– Full Guide: references/performance.md](references/performance.md)**

### TypeScript Standards
- Strict mode, no `any`
- Explicit return types
- Type imports with `import type`
- **[ðŸ“– Full Guide: references/typescript-standards.md](references/typescript-standards.md)**

### Common Patterns
- React Hook Form + Zod
- DataGrid wrappers
- Dialog standards
- **[ðŸ“– Full Guide: references/common-patterns.md](references/common-patterns.md)**

### Complete Examples
- Full component examples
- Feature structure template
- **[ðŸ“– Full Guide: references/complete-examples.md](references/complete-examples.md)**

---

## ðŸ”§ Modern Component Template
